        ...
        <div className={style.footer}>
          <div className={style.contact}>
            <div className={style.people}>
              <ImgView completeView="/src/assets/img/peo.png" 
                style={{width:"66px", height:"66px",display:"inline-block",borderRadius:"50%"}}
              />
              <span>{name}&bnsp;</span><span>{profession}</span><br/>
              <span>{tel}</span>
            </div>
