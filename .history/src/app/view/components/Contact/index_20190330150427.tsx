    ...
    return (
      <div className={style.component}>
        ...
        <section className={style.func}>
          <ul>
            <li><i class={style.icon1}/><span>空中看房</span></li>
            <li><i class={style.icon2}/><span>VR看房</span></li>
            <li><i class={style.icon3}/><span>空中看房</span></li>
            <li><i class={style.icon4}/><span>空中看房</span></li>
          </ul>
        </section>
