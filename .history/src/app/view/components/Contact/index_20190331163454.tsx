      ...
      {/* 这是头部部分的 */}
        ...
        <div className={style.buildingPrice}>
          <ImgView 
            ...
            style={{width:"345px",height:"66px",position:"relative"}}
          />
            <dl>
              <dt><span className={style.buidlingT}>均价</span><br/><span className={style.buildingN}>11111</span><span className={style.buildingU}>万m</span></dt>
              <dt><span className={style.buidlingT}>占地面积</span><br/><span className={style.buildingN}>11111</span><span className={style.buildingU}>万m</span></dt>
              <dt><span className={style.buidlingT}>建筑面积</span><br/><span className={style.buildingN}>11111</span><span className={style.buildingU}>万m</span></dt>
            </dl>
        </div>
