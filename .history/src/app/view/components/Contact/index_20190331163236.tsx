        ...
        <div className={style.buildingPrice}>
          ...
          />
            <dl>
              ...
              <dt><span className={style.buidlingT}>占地面积</span><span className={style.buildingN}>11111</span><span className={style.buildingU}>万m</span></dt>
              <dt><span className={style.buidlingT}>建筑面积</span><span className={style.buildingN}>11111</span><span className={style.buildingU}>万m</span></dt>
            </dl>
        </div>
